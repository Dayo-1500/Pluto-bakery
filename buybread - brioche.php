...
<div class="brioche-buy" title="Brioche" style="background-image:url('spritesheet-buybread.png');
  width:258px; height:315px;"> </div>
<h5 style="text-align:center;"> Brioche</h5>
</div>
...
<form action="buybread - brioche.php" method="post" style="width:100%;" oninput="price.value = b.value * c.value">
