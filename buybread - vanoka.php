...
<div class="vanoka-buy" title="Vanoka" style="background-image:url('spritesheet-buybread.png');
  width:477px; height:300px;"> </div>
<h5 style="text-align:center;"> Vanoka</h5>
</div>
...
<form action="buybread - vanoka.php" method="post" style="width:100%;" oninput="price.value = b.value * c.value">
...
<input type="hidden" name="bread_type" value="Vanoka">
<br>  
