...
<div class="English-muffins-buy" title="English muffins" style="background-image:url('spritesheet-buybread.png');
  width:271px; height:317px;"> </div>
<h5 style="text-align:center;"> English muffins</h5>
</div>
...
<form action="buybread - englishmuffins.php" method="post" style="width:100%;" oninput="price.value = b.value * c.value">
