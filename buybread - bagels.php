...
<div class="bagels-buy" title="Bagels" style="background-image:url('spritesheet-buybread.png');
  width:235px; height:315px;"> </div>
<h5 style="text-align:center;"> Bagels</h5>
</div>

<div class="effects" style="width:60%;">
...
<form action="buybread - bagels.php" method="post" style="width:100%;" oninput="price.value = b.value * c.value">
    
<label for="phone" class="d">Phone number: </label>
<input class="d g" style="margin-left:10%; width:15vw;" type="tel" name="phone" id="phone" required><br>
...
<input name="price" id="price" for="b c" value="">  </input>
