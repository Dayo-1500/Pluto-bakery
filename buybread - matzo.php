...
<div class="matzo-buy" title="Matzo" style="background-image:url('spritesheet-buybread.png');
  width:350px; height:317px;"> </div>
<h5 style="text-align:center;"> Matzo</h5>
</div>

<div class="effects" style="width:50%; margin-left:37%;">
...
<form action="buybread - matzo.php" method="post" style="width:100%;" oninput="price.value = b.value * c.value">
...
<input type="hidden" name="bread_type" value="Matzo">
<br>  
