...
<div class="multigrain-buy" title="Multigrain bread" style="background-image:url('spritesheet-buybread.png');
  width:424px; height:318px;"> </div>
<h5 style="text-align:center;"> Multigrain bread</h5>
</div>

<div class="effects" style="width:45%; margin-left:42%;">
...
<form action="buybread - multigrain.php" method="post" style="width:100%;" oninput="price.value = b.value * c.value">
...
<input type="hidden" name="bread_type" value="Multigrain bread">
<br>  
