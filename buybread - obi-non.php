...
<div class="obi-non-buy" title="Obi non" style="background-image:url('spritesheet-buybread.png');
  width:760px; height:200px;"> </div>
<h5 style="text-align:center;"> Obi non</h5>
</div>

<div class="effects" style="width:60%; margin-top:35%;">
...
<form action="buybread - obi-non.php" method="post" style="width:100%;" oninput="price.value = b.value * c.value">
