...
<div class="naan-buy" title="Naan" style="background-image:url('spritesheet-buybread.png');
  width:213px; height:320px;"> </div>
<h5 style="text-align:center;"> Naan</h5>
</div>
...
<form action="buybread - naan.php" method="post" style="width:100%;" oninput="price.value = b.value * c.value">
